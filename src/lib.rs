...
pub mod matrix {
    ...
    impl<T: std::default::Default + std::marker::Copy, const N: usize, const M: usize> Default for Matrix<T, N, M>{
        fn default() -> Self {
            Self {
                inner: [[T::default(); M]; N],
            }
    ...
    impl<T: std::default::Default + std::marker::Copy, const N: usize, const M: usize> From<Vec<Vec<T>>> for Matrix<T, N, M>{
    ...
    impl<T: std::default::Default, const N: usize, const M: usize> From<[[T; M]; N]> for Matrix<T, N, M>{
    ...
    impl<T: std::default::Default + std::fmt::Display, const N :usize, const M:usize> std::fmt::Display for Matrix<T,N,M> {
